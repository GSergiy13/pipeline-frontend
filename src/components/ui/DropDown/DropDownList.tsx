...
export const DropDownList = ({ data, show, active, handleSelect }: DropDownListProps) => {
	...
	return (
		<ul
			className={cn(
				`absolute flex flex-col top-11 w-full rounded-xl bg-[#232327]  will-change-transform transform-gpu z-50 transition-all duration-400 overflow-hidden max-h-[70vh] overflow-y-auto min-w-[180px]`,
				{
